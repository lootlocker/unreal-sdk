...
static struct FScriptStruct_LootLockerSDK_StaticRegisterNativesFLootLockerGetMapsResponse
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLootLockerGetMapsResponse>(FName(TEXT("LootLockerGetMapsResponse")));
	}
...
static struct FScriptStruct_LootLockerSDK_StaticRegisterNativesFLootLockerMap
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLootLockerMap>(FName(TEXT("LootLockerMap")));
	}
...
static struct FScriptStruct_LootLockerSDK_StaticRegisterNativesFLootLockerMapSpawnPoint
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLootLockerMapSpawnPoint>(FName(TEXT("LootLockerMapSpawnPoint")));
	}
...
static struct FScriptStruct_LootLockerSDK_StaticRegisterNativesFLootLockerMapCamera
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLootLockerMapCamera>(FName(TEXT("LootLockerMapCamera")));
	}
