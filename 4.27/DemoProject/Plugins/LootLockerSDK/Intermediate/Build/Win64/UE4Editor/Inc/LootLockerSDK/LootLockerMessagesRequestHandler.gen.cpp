...
static struct FScriptStruct_LootLockerSDK_StaticRegisterNativesFLootLockerMessagesResponse
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLootLockerMessagesResponse>(FName(TEXT("LootLockerMessagesResponse")));
	}
...
static struct FScriptStruct_LootLockerSDK_StaticRegisterNativesFLootLockerMessage
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLootLockerMessage>(FName(TEXT("LootLockerMessage")));
	}
