...
struct FLootLockerResponseAssetCandidate {
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "LootLocker")
    FLootLockerAssetCandidate2 data;
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "LootLocker")
...
class LOOTLOCKERSDK_API ULootLockerUserGeneratedContentRequestHandler : public UObject
{
    GENERATED_BODY()
public:
    static void CreateAssetCandidate(const FLootLockerAssetCandidate2& AsssetCandidate, const FCreateAssetCandidateResponseDelegateBP& OnCompletedRequestBP = FCreateAssetCandidateResponseDelegateBP(), const FCreateAssetCandidateResponseDelegate& OnCompletedRequest = FCreateAssetCandidateResponseDelegate());
    
    static void UpdateAssetCandidate(int AssetCandidateId, const FLootLockerAssetCandidate2& AsssetCandidate, const FAssetCandidateResponseDelegateBP& OnCompletedRequestBP = FAssetCandidateResponseDelegateBP(), const FAssetCandidateResponseDelegate& OnCompletedRequest = FAssetCandidateResponseDelegate());
