...
void ULootLockerProgressionsRequestHandler::GetPlayerProgressions(const int32 Count, const FString& After, const FLootLockerPaginatedPlayerProgressionsResponseBP& OnCompletedRequestBP /*= FLootLockerPaginatedPlayerProgressionsResponseBP()*/, const FLootLockerPaginatedPlayerProgressionsResponseDelegate& OnComplete /*= FLootLockerPaginatedPlayerProgressionsResponseDelegate()*/)
{
    ...
    LLAPI<FLootLockerPaginatedPlayerProgressionResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetAllPlayerProgressions, {}, QueryParams, OnCompletedRequestBP, OnComplete);
}
...
{
    LLAPI<FLootLockerPlayerProgressionResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetSinglePlayerProgression, { ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
}
...
{
    LLAPI<FLootLockerPlayerProgressionWithRewardsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::ResetPlayerProgression, { ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
}
...
{
    LLAPI<FLootLockerResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::DeletePlayerProgression, { ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
}
...
void ULootLockerProgressionsRequestHandler::GetCharacterProgressions(const int32 CharacterId, const int32 Count, const FString& After, const FLootLockerPaginatedCharacterProgressionsResponseBP& OnCompletedRequestBP /*= FLootLockerPaginatedCharacterProgressionsResponseBP()*/, const FLootLockerPaginatedCharacterProgressionsResponseDelegate& OnComplete /*= FLootLockerPaginatedCharacterProgressionsResponseDelegate()*/)
{
    ...
    LLAPI<FLootLockerPaginatedCharacterProgressionResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetAllCharacterProgressions, { CharacterId }, QueryParams, OnCompletedRequestBP, OnComplete);
}
...
{
    LLAPI<FLootLockerCharacterProgressionResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetSingleCharacterProgression, { CharacterId, ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
}
...
{
    LLAPI<FLootLockerCharacterProgressionWithRewardsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::ResetCharacterProgression, { CharacterId, ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
}
...
{
    LLAPI<FLootLockerResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::DeleteCharacterProgression, { CharacterId, ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
}
...
void ULootLockerProgressionsRequestHandler::GetProgressions(const int32 Count, const FString& After, const FLootLockerPaginatedProgressionsResponseBP& OnCompletedRequestBP /*= FLootLockerPaginatedProgressionsResponseBP()*/, const FLootLockerPaginatedProgressionsResponseDelegate& OnComplete /*= FLootLockerPaginatedProgressionsResponseDelegate()*/)
{
    ...
    LLAPI<FLootLockerPaginatedProgressionsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetAllProgressions, {}, QueryParams, OnCompletedRequestBP, OnComplete);
}
...
{
    LLAPI<FLootLockerProgressionResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetSingleProgression, { ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
}
...
void ULootLockerProgressionsRequestHandler::GetProgressionTiers(const FString& ProgressionKey, const int32 Count, const int32 After, const FLootLockerPaginatedProgressionTiersResponseBP& OnCompletedRequestBP /*= FLootLockerPaginatedProgressionTiersResponseBP()*/, const FLootLockerPaginatedProgressionTiersResponseDelegate& OnComplete /*= FLootLockerPaginatedProgressionTiersResponseDelegate()*/)
{
    ...
    LLAPI<FLootLockerPaginatedProgressionTiersResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetProgressionTiers, { ProgressionKey }, QueryParams, OnCompletedRequestBP, OnComplete);
}
...
void ULootLockerProgressionsRequestHandler::GetInstanceProgressions(const int32 AssetInstanceId, const int32 Count, const FString& After, const FLootLockerPaginatedInstanceProgressionsResponseBP& OnCompletedRequestBP, const FLootLockerPaginatedInstanceProgressionsResponseDelegate& OnComplete)
{
    ...
    LLAPI<FLootLockerPaginatedInstanceProgressionResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetAllInstanceProgressions, { AssetInstanceId }, QueryParams, OnCompletedRequestBP, OnComplete);
...
{
    LLAPI<FLootLockerInstanceProgressionResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetSingleInstanceProgression, { AssetInstanceId, ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
...
{
    LLAPI<FLootLockerInstanceProgressionWithRewardsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::ResetInstanceProgression, { AssetInstanceId, ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
...
{
    LLAPI<FLootLockerResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::DeleteInstanceProgression, { AssetInstanceId, ProgressionKey }, EmptyQueryParams, OnCompletedRequestBP, OnComplete);
