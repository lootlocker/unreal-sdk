...
{
    LLAPI<FLootLockerMissionsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetAllMissionsEndpoint, { },EmptyQueryParams,OnCompletedRequestBP, OnCompletedRequest);
}
...
{
    LLAPI<FLootLockerMissionResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetMissionEndpoint, { MissionId },EmptyQueryParams,OnCompletedRequestBP, OnCompletedRequest);
}
...
{
    LLAPI<FLootLockerStartMissionResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::StartMissionEndpoint, { MissionId },EmptyQueryParams,OnCompletedRequestBP, OnCompletedRequest);
}
