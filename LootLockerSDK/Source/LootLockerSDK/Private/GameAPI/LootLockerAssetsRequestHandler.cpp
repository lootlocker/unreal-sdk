...
{
    LLAPI<FLootLockerGetContextResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetContextsEndpoint, { },EmptyQueryParams, OnCompletedRequestBP, OnCompletedRequest);
}
...
void ULootLockerAssetsRequestHandler::GetAssets(int StartFromIndex, int ItemsCount, ELootLockerAssetFilter AssetFilter, int Context, bool IncludeUGC, const FAssetsResponseDelegateBP& OnCompletedRequestBP, const FAssetsResponseDelegate& OnCompletedRequest)
{
    ...
    LLAPI<FLootLockerGetAssetsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetAssetsEndpoint, { },QueryParams, OnCompletedRequestBP, OnCompletedRequest);
}
...
void ULootLockerAssetsRequestHandler::GetAssetsByIds(const TArray<int>& AssetIds, const FAssetsResponseDelegateBP& OnCompletedRequestBP, const FAssetsResponseDelegate& OnCompletedRequest)
{
    ...
    LLAPI<FLootLockerGetAssetsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetAssetsByIdsEndpoint, { },QueryParams, OnCompletedRequestBP, OnCompletedRequest);
}
...
{
    LLAPI<FLootLockerGetAssetBonesResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetAssetBonesEndpoint, { },EmptyQueryParams, OnCompletedRequestBP, OnCompletedRequest);
}
...
{
    LLAPI<FLootLockerGetFavouriteAssetIndicesResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetFavouriteAssetIndicesEndpoint, { },EmptyQueryParams, OnCompletedRequestBP, OnCompletedRequest);
}
...
{
    LLAPI<FLootLockerGetFavouriteAssetIndicesResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::AddAssetToFavouritesEndpoint, { AssetId },EmptyQueryParams, OnCompletedRequestBP, OnCompletedRequest);
}
...
{
    LLAPI<FLootLockerGetFavouriteAssetIndicesResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::RemoveAssetFromFavouritesEndpoint, { AssetId },EmptyQueryParams, OnCompletedRequestBP, OnCompletedRequest);
}
...
void ULootLockerAssetsRequestHandler::GetUniversalAssets(const int After, const int Count, const FUniversalAssetResponseDelegateBP &OnCompletedRequestBP, const FUniversalAssetResponseDelegate &OnCompletedRequest)
{
    ...
    LLAPI<FLootLockerUniversalAssetsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetUniversalAssetsEndpoint, {}, QueryParams, OnCompletedRequestBP, OnCompletedRequest);
}
