...
void ULootLockerLeaderboardRequestHandler::ListLeaderboards(const FLootLockerPlayerData& PlayerData, int Count, int After, const FLootLockerListLeaderboardsResponseDelegate& OnCompletedRequest)
{
	...
	LLAPI<FLootLockerListLeaderboardsResponse>::CallAPI(LootLockerEmptyRequest, ULootLockerGameEndpoints::ListLeaderboards, {}, QueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerGetMemberRankResponse>::CallAPI(LootLockerEmptyRequest, ULootLockerGameEndpoints::GetMemberRank, { MemberRequest.leaderboard_key, MemberRequest.member_id }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerGetByListOfMembersResponse>::CallAPI(GetScoreByListRequests, ULootLockerGameEndpoints::GetByListOfMembers, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
void ULootLockerLeaderboardRequestHandler::GetScoreList(const FLootLockerPlayerData& PlayerData, const FLootLockerGetScoreListRequest& GetScoreListRequests, const FLootLockerGetScoreListResponseDelegate& OnCompletedRequest)
{
	...
	LLAPI<FLootLockerGetScoreListResponse>::CallAPI(LootLockerEmptyRequest, ULootLockerGameEndpoints::GetScoreList, { GetScoreListRequests.leaderboard_key, GetScoreListRequests.count, after }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerSubmitScoreResponse>::CallAPI(SubmitScoreRequests, ULootLockerGameEndpoints::SubmitScore, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerSubmitScoreResponse>::CallAPI(QueryScoreRequests, ULootLockerGameEndpoints::QueryScore, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerSubmitScoreResponse>::CallAPI(IncrementScoreRequest, ULootLockerGameEndpoints::IncrementScore, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
void ULootLockerLeaderboardRequestHandler::GetAllMemberRanks(const FLootLockerPlayerData& PlayerData, const FLootLockerGetAllMemberRanksRequest& GetAllMemberRanksRequests, const FLootLockerGetAllMemberRanksResponseDelegate& OnCompletedRequest)
{
	...
	LLAPI<FLootLockerGetAllMemberRanksResponse>::CallAPI(LootLockerEmptyRequest, ULootLockerGameEndpoints::GetAllMemberRanks, { GetAllMemberRanksRequests.member_id }, QueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerLeaderboardDetailsResponse>::CallAPI(LootLockerEmptyRequest, ULootLockerGameEndpoints::GetLeaderboardDetails, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
