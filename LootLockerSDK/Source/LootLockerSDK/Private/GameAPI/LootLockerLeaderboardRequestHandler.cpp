...
void ULootLockerLeaderboardRequestHandler::ListLeaderboards(const FLootLockerPlayerData& PlayerData, int Count, int After, const FLootLockerListLeaderboardsResponseDelegate& OnCompletedRequest)
{
	...
	LLAPI<FLootLockerListLeaderboardsResponse>::CallAPI(HttpClient, LootLockerEmptyRequest, ULootLockerGameEndpoints::ListLeaderboards, {}, QueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerGetMemberRankResponse>::CallAPI(HttpClient, LootLockerEmptyRequest, ULootLockerGameEndpoints::GetMemberRank, { MemberRequest.leaderboard_key, MemberRequest.member_id }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerGetByListOfMembersResponse>::CallAPI(HttpClient, GetScoreByListRequests, ULootLockerGameEndpoints::GetByListOfMembers, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
void ULootLockerLeaderboardRequestHandler::GetScoreList(const FLootLockerPlayerData& PlayerData, const FLootLockerGetScoreListRequest& GetScoreListRequests, const FLootLockerGetScoreListResponseDelegate& OnCompletedRequest)
{
	...
	LLAPI<FLootLockerGetScoreListResponse>::CallAPI(HttpClient, LootLockerEmptyRequest, ULootLockerGameEndpoints::GetScoreList, { GetScoreListRequests.leaderboard_key, GetScoreListRequests.count, after }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerSubmitScoreResponse>::CallAPI(HttpClient, SubmitScoreRequests, ULootLockerGameEndpoints::SubmitScore, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerSubmitScoreResponse>::CallAPI(HttpClient, QueryScoreRequests, ULootLockerGameEndpoints::QueryScore, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerSubmitScoreResponse>::CallAPI(HttpClient, IncrementScoreRequest, ULootLockerGameEndpoints::IncrementScore, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
...
void ULootLockerLeaderboardRequestHandler::GetAllMemberRanks(const FLootLockerPlayerData& PlayerData, const FLootLockerGetAllMemberRanksRequest& GetAllMemberRanksRequests, const FLootLockerGetAllMemberRanksResponseDelegate& OnCompletedRequest)
{
	...
	LLAPI<FLootLockerGetAllMemberRanksResponse>::CallAPI(HttpClient, LootLockerEmptyRequest, ULootLockerGameEndpoints::GetAllMemberRanks, { GetAllMemberRanksRequests.member_id }, QueryParams, PlayerData, OnCompletedRequest);
}
...
{
	LLAPI<FLootLockerLeaderboardDetailsResponse>::CallAPI(HttpClient, LootLockerEmptyRequest, ULootLockerGameEndpoints::GetLeaderboardDetails, { LeaderboardKey }, EmptyQueryParams, PlayerData, OnCompletedRequest);
}
