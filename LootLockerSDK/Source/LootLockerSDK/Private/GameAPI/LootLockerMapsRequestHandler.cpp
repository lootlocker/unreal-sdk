...
{
    LLAPI<FLootLockerGetMapsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::GetAllMapsEndpoint, { },EmptyQueryParams, OnCompletedRequestBP, OnCompletedRequest);
}
