...
{
    LLAPI<FLootLockerGetMapsResponse>::CallAPI(HttpClient, FLootLockerEmptyRequest(), ULootLockerGameEndpoints::SubmitScore, { },EmptyQueryParams,OnCompletedRequestBP, OnCompletedRequest);
}
