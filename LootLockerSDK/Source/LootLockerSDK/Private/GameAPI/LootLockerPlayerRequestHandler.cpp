...
void ULootLockerPlayerRequestHandler::GetPlayerInfo(const FLootLockerPlayerData& PlayerData, const FPInfoResponseBP& OnCompletedRequestBP, const FLootLockerPlayerInformationResponse& OnCompletedRequest)
{
	LLAPI<FLootLockerPlayerInfoResponse>::CallAPI(HttpClient, LootLockerEmptyRequest, ULootLockerGameEndpoints::GetPlayerInfoEndPoint, { }, EmptyQueryParams, PlayerData, OnCompletedRequestBP, OnCompletedRequest);
}
...
void ULootLockerPlayerRequestHandler::SubmitXp(const FLootLockerPlayerData& PlayerData, int Points, const FPSubmitResponseBP& OnCompletedRequestBP, const FSubmitXpResponse& OnCompletedRequest)
{
	FLootLockerSubmitXpRequest AuthRequest;
	AuthRequest.points = Points;

	LLAPI<FLootLockerSubmitXpResponse>::CallAPI(HttpClient, AuthRequest, ULootLockerGameEndpoints::SubmitXpEndpoint, {  }, EmptyQueryParams, PlayerData, OnCompletedRequestBP, OnCompletedRequest);
}

void ULootLockerPlayerRequestHandler::GetOtherPlayersXpAndLevel(const FLootLockerPlayerData& PlayerData, FString OtherPlayerId, FString OtherPlayerPlatform, const FPOtherPlayersXpAndLevelBP OnCompletedRequestBP, const FOtherPlayersXpAndLevelResponse& OnCompletedRequest)
{
	...
	LLAPI<FLootLockerOtherPlayersXpAndLevelResponse>::CallAPI(HttpClient, LootLockerEmptyRequest, ULootLockerGameEndpoints::GetOtherPlayersXpAndLevelEndpoint, { OtherPlayerId }, QueryParams, PlayerData, OnCompletedRequestBP, OnCompletedRequest);
}

void ULootLockerPlayerRequestHandler::GetMultiplePlayersXp(const FLootLockerPlayerData& PlayerData, FLootLockerMultiplePlayersXpRequest Request, const FPMultiplePlayersXPBP& OnCompletedRequestBP, const FPMultiplePlayersXP& OnCompletedRequest)
{
	LLAPI<FLootLockerMultiplePlayerXpResponse>::CallAPI(HttpClient, Request, ULootLockerGameEndpoints::GetMultipleOtherPlayersXPAndLevel, {  }, EmptyQueryParams, PlayerData, OnCompletedRequestBP, OnCompletedRequest);
}
