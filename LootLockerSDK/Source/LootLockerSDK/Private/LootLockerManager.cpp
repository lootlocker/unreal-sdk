...
void ULootLockerManager::VerifyPlayerAndStartSteamSession(const FLootLockerPlayerData& ForPlayer, const FString& SteamId64, const FString& PlatformToken, const int SteamAppId, const FAuthResponseBP& OnCompletedRequest)
{
    ULootLockerAuthenticationRequestHandler::VerifyPlayer(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, PlatformToken, ULootLockerPlatforms::GetPlatformRepresentationForPlatform(ELootLockerPlatform::Steam).AuthenticationProviderString, SteamAppId, FLootLockerDefaultResponseBP(), FLootLockerDefaultDelegate::CreateLambda([SteamId64, OnCompletedRequest](FLootLockerResponse VerifyPlayerResponse)
        {
...
void ULootLockerManager::GetPlayerInfo(const FLootLockerPlayerData& ForPlayer, const FPInfoResponseBP& OnGetPlayerInfoRequestComplete)
{
    ULootLockerPlayerRequestHandler::GetPlayerInfo(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, OnGetPlayerInfoRequestComplete);
}
...
void ULootLockerManager::SubmitXP(const FLootLockerPlayerData& ForPlayer, int Points, const FPSubmitResponseBP& OnSubmitXPRequestCompleted)
{
    ULootLockerPlayerRequestHandler::SubmitXp(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, Points, OnSubmitXPRequestCompleted);
}

void ULootLockerManager::GetOtherPlayersXpAndLevel(const FLootLockerPlayerData& ForPlayer, FString OtherPlayerId, const FPOtherPlayersXpAndLevelBP& OnGetOtherPlayersXpAndLevelRequestCompleted, FString OtherPlayerPlatform)
{
    ULootLockerPlayerRequestHandler::GetOtherPlayersXpAndLevel(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, OtherPlayerId, OtherPlayerPlatform, OnGetOtherPlayersXpAndLevelRequestCompleted);
}

void ULootLockerManager::GetMultiplePlayersXp(const FLootLockerPlayerData& ForPlayer, FString Platform, TArray<FString> PlayerIDs, const FPMultiplePlayersXPBP& OnGetOtherPlayerInfoRequestCompleted)
{
    FLootLockerMultiplePlayersXpRequest request;
    request.platform = Platform;
    request.player_ids = PlayerIDs;
    ULootLockerPlayerRequestHandler::GetMultiplePlayersXp(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, request, OnGetOtherPlayerInfoRequestCompleted);
}
...
void ULootLockerManager::PurchaseAssets(const FLootLockerPlayerData& ForPlayer, const TArray<FLootLockerAssetPurchaseData>& PurchaseData, const FPurchaseResponseDelegateBP& OnPurchaseAssetsCompleted)
{
    ULootLockerPurchasesRequestHandler::PurchaseAssets(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, PurchaseData, OnPurchaseAssetsCompleted);
}

void ULootLockerManager::PurchaseAssetsAndroid(const FLootLockerPlayerData& ForPlayer, const TArray<FLootLockerAndroidAssetPurchaseData>& PurchaseData, const  FPurchaseResponseDelegateBP& OnPurchaseAssetsAndroidCompleted)
{
    ULootLockerPurchasesRequestHandler::PurchaseAssetsAndroid(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, PurchaseData, OnPurchaseAssetsAndroidCompleted);
}

void ULootLockerManager::PurchaseAssetsIOS(const FLootLockerPlayerData& ForPlayer, const TArray<FLootLockerVerifyPurchaseIosData>& PurchaseData, const FPurchaseResponseDelegateBP& OnPurchaseAssetsIOSCompleted)
{
    ULootLockerPurchasesRequestHandler::PurchaseAssetsIOS(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, PurchaseData, OnPurchaseAssetsIOSCompleted);
}

void ULootLockerManager::PollingOrderStatus(const FLootLockerPlayerData& ForPlayer, int PurchaseId, const FPurchaseStatusResponseDelegateBP& OnPollingStatusCompleted)
{
    ULootLockerPurchasesRequestHandler::PollingOrderStatus(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, PurchaseId, OnPollingStatusCompleted);
}
...
void ULootLockerManager::GetOrderDetails(const FLootLockerPlayerData& ForPlayer, int32 OrderId, const bool NoProducts, const FOrderStatusDetailsBP& OnCompleteBP)
{
    ULootLockerPurchasesRequestHandler::GetOrderDetails(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, OrderId, NoProducts, OnCompleteBP, FOrderStatusDetailsDelegate());
}
...
void ULootLockerManager::TriggerEvent(const FLootLockerPlayerData& ForPlayer, const FLootLockerTriggerEvent& Event, const FTriggerEventResponseDelegateBP& OnTriggerEventCompleted)
{
    ULootLockerTriggerEventsRequestHandler::TriggerEvent(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, Event, OnTriggerEventCompleted);
}

void ULootLockerManager::GetTriggeredEvents(const FLootLockerPlayerData& ForPlayer, const FTriggersResponseDelegateBP& OnGetTriggeredEventsCompleted)
{
    ULootLockerTriggerEventsRequestHandler::GetTriggeredEvents(ForPlayer.PlayerUlid.IsEmpty() ? GetSavedStateOrDefaultOrEmptyForPlayer("") : ForPlayer, OnGetTriggeredEventsCompleted);
}
