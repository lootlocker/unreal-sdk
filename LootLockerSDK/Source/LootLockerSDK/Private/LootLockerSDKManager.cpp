...
void ULootLockerSDKManager::VerifyPlayerAndStartSteamSession(const FString& SteamId64, const FString& PlatformToken, const FLootLockerSessionResponse& OnCompletedRequest, const int SteamAppId /* = -1 */, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerAuthenticationRequestHandler::VerifyPlayer(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), PlatformToken, ULootLockerPlatforms::GetPlatformRepresentationForPlatform(ELootLockerPlatform::Steam).AuthenticationProviderString, SteamAppId, FLootLockerDefaultResponseBP(), FLootLockerDefaultDelegate::CreateLambda([SteamId64, OnCompletedRequest](FLootLockerResponse VerifyPlayerResponse)
        {
            if(!VerifyPlayerResponse.success)
            {
                ...
                AuthResponse.Context = VerifyPlayerResponse.Context;
...
// Remote Sessions
//==================================================
FString ULootLockerSDKManager::StartRemoteSession(const FLootLockerLeaseRemoteSessionResponseDelegate& RemoteSessionLeaseInformation, const FLootLockerRemoteSessionStatusPollingResponseDelegate& RemoteSessionLeaseStatusUpdate, const FLootLockerStartRemoteSessionResponseDelegate& OnComplete, float PollingIntervalSeconds, float TimeOutAfterMinutes, const FString ForPlayerWithUlid /* = "" */)
{
    return ULootLockerRemoteSessionRequestHandler::StartRemoteSession(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), FLootLockerLeaseRemoteSessionResponseDelegateBP(), RemoteSessionLeaseInformation, FLootLockerRemoteSessionStatusPollingResponseDelegateBP(), RemoteSessionLeaseStatusUpdate, FLootLockerStartRemoteSessionResponseDelegateBP(), OnComplete, PollingIntervalSeconds, TimeOutAfterMinutes);
}

void ULootLockerSDKManager::CancelRemoteSessionProcess(const FString& ProcessID, const FString ForPlayerWithUlid /* = "" */)
{
...
void ULootLockerSDKManager::GetPlayerInfo(const FLootLockerPlayerInformationResponse& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerPlayerRequestHandler::GetPlayerInfo(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), FPInfoResponseBP(), OnCompletedRequest);
}
...
void ULootLockerSDKManager::SubmitXP(int Points, const FSubmitXpResponse& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerPlayerRequestHandler::SubmitXp(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), Points, FPSubmitResponseBP(), OnCompletedRequest);
}

void ULootLockerSDKManager::GetOtherPlayersXpAndLevel(FString OtherPlayerId, const FOtherPlayersXpAndLevelResponse& OnCompletedRequest, FString OtherPlayerPlatform, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerPlayerRequestHandler::GetOtherPlayersXpAndLevel(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), OtherPlayerId, OtherPlayerPlatform, FPOtherPlayersXpAndLevelBP(), OnCompletedRequest);
}

void ULootLockerSDKManager::GetMultiplePlayersXp(FLootLockerMultiplePlayersXpRequest& Request, const FPMultiplePlayersXP& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerPlayerRequestHandler::GetMultiplePlayersXp(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), Request, FPMultiplePlayersXPBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetsRequestHandler::GetContexts(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), FContextDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetsRequestHandler::GetAssets(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), StartFromIndex, ItemsCount, AssetFilter, Context, IncludeUGC, FAssetsResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetsRequestHandler::GetUniversalAssets(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), After, ItemsCount, FUniversalAssetResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetsRequestHandler::GetAssetsByIds(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetIds, FAssetsResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetsRequestHandler::GetAssetBones(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), FAssetBonesResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetsRequestHandler::GetFavouriteAssetIndices(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), FGetFavouriteAssetIndicesResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetsRequestHandler::AddAssetToFavourites(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetId, FGetFavouriteAssetIndicesResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetsRequestHandler::RemoveAssetFromFavourites(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetId, FGetFavouriteAssetIndicesResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetInstancesRequestHandler::GetAllKeyValuePairsForAssetInstance(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetInstanceId, FAssetInstanceStorageItemsResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetInstancesRequestHandler::GetAKeyValuePairByIdForAssetInstance(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetInstanceId, StorageItemId, FAssetInstanceStorageItemResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetInstancesRequestHandler::CreateAKeyValuePairForAssetInstance(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetInstanceId, Item, FAssetInstanceStorageItemsResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetInstancesRequestHandler::UpdateOneOrMoreKeyValuePairForAssetInstance(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetInstanceId, Items, FAssetInstanceStorageItemsResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetInstancesRequestHandler::UpdateAKeyValuePairByIdForAssetInstance(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetInstanceId, StorageItemId, Item, FAssetInstanceStorageItemResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetInstancesRequestHandler::DeleteAKeyValuePairByIdForAssetInstance(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetInstanceId, StorageItemId, FAssetInstanceStorageItemsResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetInstancesRequestHandler::InspectLootBox(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetInstanceId, FLootBoxContentResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetInstancesRequestHandler::OpenLootBox(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetInstanceId, FOpenLootBoxResponseDelegateBP(), OnCompletedRequest);
}
...
{
    ULootLockerAssetInstancesRequestHandler::DeleteAssetInstanceFromPlayerInventory(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetInstanceID, FDeleteAssetInstanceResponseDelegateBP(), OnCompletedRequest);
}
...
void ULootLockerSDKManager::AddFileToAssetCandidate(int AssetCandidateId, const FString& FilePath, ELootLockerAssetFilePurpose FilePurpose, const FResponseCallback& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerUserGeneratedContentRequestHandler::AddFileToAssetCandidate(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), AssetCandidateId, FilePath, FilePurpose, FResponseCallbackBP(), OnCompletedRequest);
}
...
//Purchasing
void ULootLockerSDKManager::PurchaseAssets(const TArray<FLootLockerAssetPurchaseData>& PurchaseData, const FPurchaseResponseDelegate& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerPurchasesRequestHandler::PurchaseAssets(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), PurchaseData, FPurchaseResponseDelegateBP(), OnCompletedRequest);
}

void ULootLockerSDKManager::PurchaseAssetsAndroid(const TArray<FLootLockerAndroidAssetPurchaseData>& PurchaseData, const FPurchaseResponseDelegate& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerPurchasesRequestHandler::PurchaseAssetsAndroid(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), PurchaseData, FPurchaseResponseDelegateBP(), OnCompletedRequest);
}

void ULootLockerSDKManager::PurchaseAssetsIOS(const TArray<FLootLockerVerifyPurchaseIosData>& PurchaseData, const FPurchaseResponseDelegate& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerPurchasesRequestHandler::PurchaseAssetsIOS(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), PurchaseData, FPurchaseResponseDelegateBP(), OnCompletedRequest);
}

void ULootLockerSDKManager::PollingOrderStatus(int PurchaseId, const FPurchaseStatusResponseDelegate& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerPurchasesRequestHandler::PollingOrderStatus(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), PurchaseId, FPurchaseStatusResponseDelegateBP(), OnCompletedRequest);
}
...
void ULootLockerSDKManager::GetOrderDetails(int32 OrderId, const bool NoProducts, const FOrderStatusDetailsDelegate& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerPurchasesRequestHandler::GetOrderDetails(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), OrderId, NoProducts, FOrderStatusDetailsBP(), OnCompletedRequest);
}
...
//Trigger
void ULootLockerSDKManager::TriggerEvent(const FLootLockerTriggerEvent& Event, const FTriggerEventResponseDelegate& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerTriggerEventsRequestHandler::TriggerEvent(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), Event, FTriggerEventResponseDelegateBP(), OnCompletedRequest);
}

void ULootLockerSDKManager::GetTriggeredEvents(const FTriggersResponseDelegate& OnCompletedRequest, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerTriggerEventsRequestHandler::GetTriggeredEvents(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), FTriggersResponseDelegateBP(), OnCompletedRequest);
}
...
void ULootLockerSDKManager::ListNotifications(bool ShowRead, const FString& OfType, const FString& WithSource, int PerPage, int Page, const FLootLockerListNotificationsResponseDelegate& OnComplete, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerNotificationsRequestHandler::ListNotifications(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), ShowRead, OfType, WithSource, PerPage, Page, FLootLockerListNotificationsResponseBP(), OnComplete);
}

void ULootLockerSDKManager::ListNotificationsWithPriority(ELootLockerNotificationPriority WithPriority, bool ShowRead, const FString& OfType, const FString& WithSource, int PerPage, int Page, const FLootLockerListNotificationsResponseDelegate& OnComplete, const FString ForPlayerWithUlid /* = "" */)
{
    ULootLockerNotificationsRequestHandler::ListNotifications(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), WithPriority, ShowRead, OfType, WithSource, PerPage, Page, FLootLockerListNotificationsResponseBP(), OnComplete);
}
...
{
    ULootLockerBalanceRequestHandler::ListBalancesInWallet(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), WalletID, FLootLockerListBalancesForWalletResponseBP(), OnComplete);
}
...
{
    ULootLockerBalanceRequestHandler::GetWalletByWalletID(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), WalletID, FLootLockerGetWalletResponseBP(), OnComplete);
}
...
{
    ULootLockerBalanceRequestHandler::GetWalletByHolderID(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), HolderULID, HolderType, FLootLockerGetWalletResponseBP(), OnComplete);
}
...
{
    ULootLockerBalanceRequestHandler::CreditBalanceToWallet(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), WalletID, CurrencyID, Amount, FLootLockerCreditWalletResponseBP(), OnComplete);
}
...
{
    ULootLockerBalanceRequestHandler::DebitBalanceToWallet(GetSavedStateOrDefaultOrEmptyForPlayer(ForPlayerWithUlid), WalletID, CurrencyID, Amount, FLootLockerDebitWalletResponseBP(), OnComplete);
}
