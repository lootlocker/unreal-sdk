...
FLootLockerEndPoints ULootLockerGameEndpoints::StartGooglePlayGamesSessionEndpoint = InitEndpoint("session/google-play-games/v1/login", ELootLockerHTTPMethod::POST);
FLootLockerEndPoints ULootLockerGameEndpoints::RefreshGooglePlayGamesSessionEndpoint = InitEndpoint("session/google-play-games/v1/login", ELootLockerHTTPMethod::POST);
...
FLootLockerEndPoints ULootLockerGameEndpoints::DeleteCharacterEndpoint = InitEndpoint("v1/player/character/{0}", ELootLockerHTTPMethod::DELETE);
...
FLootLockerEndPoints ULootLockerGameEndpoints::QueryScore = InitEndpoint("leaderboards/{0}/query", ELootLockerHTTPMethod::POST);
FLootLockerEndPoints ULootLockerGameEndpoints::IncrementScore = InitEndpoint("leaderboards/{0}/increment", ELootLockerHTTPMethod::POST);
...
FLootLockerEndPoints ULootLockerGameEndpoints::ListCatalogItemsByKey = InitEndpoint("catalogs/inspired-ibex/v1/catalog/key/{key}/list", ELootLockerHTTPMethod::GET);
