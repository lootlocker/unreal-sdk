...
BEGIN_DEFINE_SPEC(FTestLootLockerCharacters, "LootLocker.Characters", EAutomationTestFlags::Disabled /*Test is outdated, needs updates */ | EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
