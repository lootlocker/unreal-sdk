...
BEGIN_DEFINE_SPEC(FLootLockersTestLeaderboards, "LootLocker.Leaderboards", EAutomationTestFlags::Disabled /*Test is outdated, needs updates */ | EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
