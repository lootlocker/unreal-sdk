...
BEGIN_DEFINE_SPEC(FTestLootLockerMessages, "LootLocker.Messages", EAutomationTestFlags::Disabled /*Test is outdated, needs updates */ | EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
