...
BEGIN_DEFINE_SPEC(FTestLootLockerDroptables, "LootLocker.DropTables", EAutomationTestFlags::Disabled /*Test is outdated, needs updates */ | EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
