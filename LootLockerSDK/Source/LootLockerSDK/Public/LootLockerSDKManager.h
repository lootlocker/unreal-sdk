...
#pragma warning(suppress : 4996)
        return ListCatalogItems(CatalogKey, -1, "", OnComplete, ForPlayerWithUlid); 
#pragma warning(default : 4996)
    ...
    */
    ...
    /**
     ...
     @param OnComplete Callback indicating whether the connection and authentication succeeded
    ...
    /**
     ...
     @param OnComplete Optional callback indicating whether the disconnection succeeded
     @param ForPlayerWithUlid Optional: Execute the request for the specified player. If not supplied, the default player will be used.
     */
    ...
    /**
     ...
     @return Array of player ULIDs that have active presence connections
     */
    ...
    /**
     ...
     @param OnComplete Callback for the result of the operation
     @param ForPlayerWithUlid Optional: Execute the request for the specified player. If not supplied, the default player will be used.
     */
    ...
    /**
     ...
     @param ForPlayerWithUlid Optional: Execute the request for the specified player. If not supplied, the default player will be used.
     @return The last sent status string, or empty if no client is found or no status has been sent
     */
