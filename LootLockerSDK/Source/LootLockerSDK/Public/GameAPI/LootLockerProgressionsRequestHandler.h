...
DECLARE_DYNAMIC_DELEGATE_OneParam(FLootLockerInstanceProgressionResponseBP, FLootLockerGenericProgressionResponse, Response);
DECLARE_DYNAMIC_DELEGATE_OneParam(FLootLockerPaginatedInstanceProgressionsResponseBP, FLootLockerPaginatedGenericProgressionResponse, Response);
DECLARE_DYNAMIC_DELEGATE_OneParam(FLootLockerInstanceProgressionWithRewardsResponseBP, FLootLockerGenericProgressionWithRewardsResponse, Response);
...
DECLARE_DELEGATE_OneParam(FLootLockerInstanceProgressionResponseDelegate, FLootLockerGenericProgressionResponse);
DECLARE_DELEGATE_OneParam(FLootLockerPaginatedInstanceProgressionsResponseDelegate, FLootLockerPaginatedGenericProgressionResponse);
DECLARE_DELEGATE_OneParam(FLootLockerInstanceProgressionWithRewardsResponseDelegate, FLootLockerGenericProgressionWithRewardsResponse);
