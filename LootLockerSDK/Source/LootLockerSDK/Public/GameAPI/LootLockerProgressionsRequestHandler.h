...
public:
    ...
    static void GetOtherPlayersProgressions(const FString& PlayerUlid, const int32 Count, const FString& After, const FLootLockerPaginatedPlayerProgressionsResponseBP& OnCompletedRequestBP = FLootLockerPaginatedPlayerProgressionsResponseBP(), const FLootLockerPaginatedPlayerProgressionsResponseDelegate& OnComplete = FLootLockerPaginatedPlayerProgressionsResponseDelegate());
    static void GetOtherPlayersProgression(const FString& PlayerUlid, const FString& ProgressionKey, const FLootLockerPlayerProgressionResponseBP& OnCompletedRequestBP = FLootLockerPlayerProgressionResponseBP(), const FLootLockerPlayerProgressionResponseDelegate& OnComplete = FLootLockerPlayerProgressionResponseDelegate());
