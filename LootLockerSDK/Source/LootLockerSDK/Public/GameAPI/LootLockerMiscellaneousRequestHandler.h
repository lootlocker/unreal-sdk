...
public:
    ...
    static void GetGameInfo(const FGameInfoResponseDelegateBP& OnCompletedRequestBP = FGameInfoResponseDelegateBP(), const FGameInfoResponseDelegate& OnCompletedRequest = FGameInfoResponseDelegate());
public:
