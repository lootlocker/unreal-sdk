...
public:
     ...
     * @param bPauseOnBackground Whether to enable pause-on-background
     */
    static void SetPauseOnBackgroundEnabled(bool bPauseOnBackground);
