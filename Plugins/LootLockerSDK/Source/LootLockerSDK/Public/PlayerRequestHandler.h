...
public:
	...
	static void SubmitXp(const int32& points, const FPSubmitResponseBP& onCompletedRequestBP = FPSubmitResponseBP(), const FLootLockerSubmitXpResponse& onCompletedRequest = FLootLockerSubmitXpResponse());
