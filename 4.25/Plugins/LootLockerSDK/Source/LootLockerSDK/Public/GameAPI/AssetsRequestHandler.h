...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FContextDelegateBP, FGetContextResponse, ContextsResponse);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAssetsResponseDelegateBP, FGetAssetsResponse, AssetsResponse);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAssetBonesResponseDelegateBP, FGetAssetBonesResponse, AssetBonesResponse);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FGetFavouriteAssetIndicesResponseDelegateBP, FGetFavouriteAssetIndicesResponse, FavouriteAssetIndicesResponse);
