...
{
	LLAPI<FLootLockerGetMemberRankResponse>::CallAPI(HttpClient, MemberRequest, ULootLockerGameEndpoints::GetMemberRank, { },EmptyQueryParams,OnCompletedRequestBP, OnCompletedRequest);
}
