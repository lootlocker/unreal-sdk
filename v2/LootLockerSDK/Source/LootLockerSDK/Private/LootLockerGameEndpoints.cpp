...
FLootLockerEndPoints ULootLockerGameEndpoints::WhiteLabelVerifyEndpoint = InitEndpoint("white-label-login/verify-session", ELootLockerHTTPMethod::POST);
...
FLootLockerEndPoints ULootLockerGameEndpoints::DeleteFileEndpoint = InitEndpoint("player/files/{0}", ELootLockerHTTPMethod::DEL);
//Player
...
FLootLockerEndPoints ULootLockerGameEndpoints::GetMultipleOtherPlatersXPAndLevel = InitEndpoint("v1/player/scores", ELootLockerHTTPMethod::POST);
...
FLootLockerEndPoints ULootLockerGameEndpoints::DeleteHero = InitEndpoint("v1/player/heroes/{0}", ELootLockerHTTPMethod::DEL);
...
FLootLockerEndPoints ULootLockerGameEndpoints::RemoveAssetToHeroLoadout = InitEndpoint("v1/player/heroes/{0}/loadout/{1}", ELootLockerHTTPMethod::DEL);
...
FLootLockerEndPoints ULootLockerGameEndpoints::GetAllMemberRanks = InitEndpoint("leaderboards/member/", ELootLockerHTTPMethod::GET);
